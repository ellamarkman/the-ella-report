    ...
    <>
      ...
      <section className="discussionSection">
        <div className="discussionHeader">
          ...
          <h2>How many partnerships is too many?</h2>

          <span>
            Do you think having too many brand partnerships can hurt an
            artist&apos;s identity? I&apos;d love to hear what you think about
            KATSEYE&apos;s partnerships, other artists or groups you think do
            this well, or ideas for a future issue of The Ella Report.
          </span>
        </div>
