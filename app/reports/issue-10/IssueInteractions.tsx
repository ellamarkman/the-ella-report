    ...
    <>
      ...
      <section className="discussionSection">
        <div className="discussionHeader">
          ...
          <h2>Who did I match best?</h2>

          <span>
            Which pro and brand partnership would you actually want to see?
            Or, if you think you have a better match for one of the pros, pitch
            me your partnership.
          </span>
        </div>
        ...
        <form className="commentForm" onSubmit={handleSubmit}>
          ...
          <label htmlFor="commentText">Your Partnership Pick</label>

          <textarea
            id="commentText"
            name="commentText"
            placeholder="Which partnership is your favorite?"
            rows={6}
            value={commentText}
            maxLength={1000}
        ...
        <div className="commentsList">
          {isLoadingComments ? (
            ...
            <div className="emptyComments">
              <p>No partnership picks yet.</p>
              <span>Be the first to share your favorite matchup.</span>
            </div>
          ) : (
