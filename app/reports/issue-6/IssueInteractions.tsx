    ...
    <>
      ...
      <section className="discussionSection">
        <div className="discussionHeader">
          ...
          <h2>What brand reinvented its category?</h2>

          <span>
            Is there a brand you think completely changed the way people think
            about an industry? Or is there a SKIMS campaign, partnership, or
            marketing move that stood out to you? I&apos;d love to hear your
            take or ideas for a future issue of The Ella Report.
          </span>
        </div>
