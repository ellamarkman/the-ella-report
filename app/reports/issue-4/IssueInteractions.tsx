    ...
    <>
      ...
      <section className="discussionSection">
        <div className="discussionHeader">
          ...
          <h2>Enter the Bravoverse.</h2>

          <span>
            What's your favorite Bravo show, cast member, or unforgettable
            reality TV moment? I'd love to hear your take or ideas for a future
            issue.
          </span>
        </div>
